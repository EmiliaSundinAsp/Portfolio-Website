				...
				<Routes>
					<Route path="/about" element={<MainPage>
						...
						<div className='AboutContainer'>
							<Section heading="Who's Emilia Sundin Asp?" paragraph="I am a 35 year old woman living i Norrköping with my boyfriend of many years, and our awesome 4-year-old boy. I consider myself creative and like painting, interior design and web design (although I am a complete novis at the latter!)."/>
							...
							<Section heading="What is Emilia studying?" paragraph="I'm studying my first year at KYH Anywhere to become a front end developer. So far I've learned a lot, but it only makes me realize how expansive the field of developing is. But no matter, I'm determined to learn as much as possible!"/>
						</div>
					</MainPage>} />
					<Route path="/skills" element={<MainPage>
						<Title title="Skills"/>
						<div className='SkillsContainer'>
							<List heading="General skills:" listItem="Attention to detail" listItem2="Creative - with an eye for design" listItem3="Good team player" listItem4="Persistant" listItem5="Self reliant" listItem6="Fantastic sense of humor"/>
							<List heading="Coding skills:" listItem="Vanilla JavaScript" listItem2="Semantic HTML" listItem3="CSS/SASS" listItem4="React" listItem5="... and working on more!"/>
						</div>
					</MainPage>} />
